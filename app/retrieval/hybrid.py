"""Hybrid retrieval: semantic vector search + BM25 keyword boost."""
...
from app.db.vector_store import Scope, semantic_search
from app.utils.logger import get_logger

logger = get_logger(__name__)
settings = get_settings()

ALPHA = 0.70  # semantic weight vs BM25
...
async def hybrid_retrieve(
    ...
    candidates = await semantic_search(query_embedding, top_k=k * 2, scope=scope)
    if not candidates:
        return []
